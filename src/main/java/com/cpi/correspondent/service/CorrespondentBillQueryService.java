...
public class CorrespondentBillQueryService extends QueryService<CorrespondentBill> {
    ...
    @Transactional(readOnly = true)
    public List<CorrespondentBillDTO> findByCpiCorrespondent(Long cpiCorrespondentId) {
...
//    }
    ...
    private Specifications<CorrespondentBill> createSpecification(CorrespondentBillCriteria criteria) {
        ...
        if (criteria != null) {
            ...
            if (criteria.getCorrespondentBillStatusId() != null) {
                specification = specification.and(buildReferringEntitySpecification(criteria.getCorrespondentBillStatusId(), CorrespondentBill_.correspondentBillStatus, CorrespondentBillStatus_.id));
            }
