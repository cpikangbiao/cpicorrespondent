...
/**
 * Service Implementation for managing {@link CorrespondentBill}.
 */
@Service
@Transactional
public class CorrespondentBillServiceImpl implements CorrespondentBillService {
    ...
    @Override
    @Transactional(readOnly = true)
    public Optional<CorrespondentBillDTO> findOne(Long id) {
        log.debug("Request to get CorrespondentBill : {}", id);
        return correspondentBillRepository.findById(id)
            .map(correspondentBillMapper::toDto);
    }
    ...
    public void delete(Long id) {
        ...
        correspondentBillRepository.deleteById(id);
    }
}
