...
/**
 * Integration tests for the {@Link CorrespondentFeeAndBillResource} REST controller.
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, CpicorrespondentApp.class})
public class CorrespondentFeeAndBillResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static CorrespondentFeeAndBill createUpdatedEntity(EntityManager em) {
        CorrespondentFeeAndBill correspondentFeeAndBill = new CorrespondentFeeAndBill();
        return correspondentFeeAndBill;
    }
    ...
    public void getAllCorrespondentFeeAndBillsByCorrespondentDebitBillIsEqualToSomething() throws Exception {
        // Initialize the database
        CorrespondentBill correspondentDebitBill = CorrespondentBillResourceIT.createEntity(em);
    ...
    public void getAllCorrespondentFeeAndBillsByCorrespondentFeeIsEqualToSomething() throws Exception {
        // Initialize the database
        CorrespondentFee correspondentFee = CorrespondentFeeResourceIT.createEntity(em);
    ...
    public void getAllCorrespondentFeeAndBillsByCorrespondentCreditBillIsEqualToSomething() throws Exception {
        // Initialize the database
        CorrespondentBill correspondentCreditBill = CorrespondentBillResourceIT.createEntity(em);
    ...
    private void defaultCorrespondentFeeAndBillShouldBeFound(String filter) throws Exception {
        ...
        restCorrespondentFeeAndBillMockMvc.perform(get("/api/correspondent-fee-and-bills/count?sort=id,desc&" + filter))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
    ...
    public void updateCorrespondentFeeAndBill() throws Exception {
        ...
        CorrespondentFeeAndBill updatedCorrespondentFeeAndBill = correspondentFeeAndBillRepository.findById(correspondentFeeAndBill.getId()).get();
    ...
    public void deleteCorrespondentFeeAndBill() throws Exception {
        ...
        // Delete the correspondentFeeAndBill
