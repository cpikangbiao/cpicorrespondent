...
/**
 * Test class for the CorrespondentDocsResource REST controller.
 *
 * @see CorrespondentDocsResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = {CpicorrespondentApp.class, SecurityBeanOverrideConfiguration.class})
public class CorrespondentDocsResourceIntTest {
    ...
    public void updateCorrespondentDocs() throws Exception {
        ...
        CorrespondentDocs updatedCorrespondentDocs = correspondentDocsRepository.findOne(correspondentDocs.getId());
    ...
    public void updateNonExistingCorrespondentDocs() throws Exception {
        ...
        // Validate the CorrespondentDocs in the database
        List<CorrespondentDocs> correspondentDocsList = correspondentDocsRepository.findAll();
        assertThat(correspondentDocsList).hasSize(databaseSizeBeforeUpdate + 1);
    }
