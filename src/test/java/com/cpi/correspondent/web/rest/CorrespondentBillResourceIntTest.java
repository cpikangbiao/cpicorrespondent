...
/**
 * Test class for the CorrespondentBillResource REST controller.
 *
 * @see CorrespondentBillResource
 */
@RunWith(SpringRunner.class)
@SpringBootTest(classes = {CpicorrespondentApp.class, SecurityBeanOverrideConfiguration.class})
public class CorrespondentBillResourceIntTest {
    ...
    public void getAllCorrespondentBillsByCorrespondentBillStatusIsEqualToSomething() throws Exception {
        // Initialize the database
        CorrespondentBillStatus correspondentBillStatus = CorrespondentBillStatusResourceIntTest.createEntity(em);
    ...
    public void getAllCorrespondentBillsByBillFinanceTypeIsEqualToSomething() throws Exception {
        // Initialize the database
        BillFinanceType billFinanceType = BillFinanceTypeResourceIntTest.createEntity(em);
    ...
    public void updateCorrespondentBill() throws Exception {
        ...
        CorrespondentBill updatedCorrespondentBill = correspondentBillRepository.findOne(correspondentBill.getId());
    ...
    public void updateNonExistingCorrespondentBill() throws Exception {
        ...
        // Validate the CorrespondentBill in the database
        List<CorrespondentBill> correspondentBillList = correspondentBillRepository.findAll();
        assertThat(correspondentBillList).hasSize(databaseSizeBeforeUpdate + 1);
    }
